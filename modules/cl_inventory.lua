...
RegisterNetEvent('crixz:ii')
AddEventHandler('crixz:ii', function(value, quantity)
...
local crixzMenu =  RageUI.CreateSubMenu(allmenu, "Options", "~s~")
...
crixzMenu:DisplayGlare(true)
crixzMenu:SetStyleSize(100);
crixzMenu:DisplayPageCounter(true)
    ...
    while openInventory do
        RageUI.IsVisible(allmenu, function()
            ...
            RageUI.Button('Portefeuille', nil, {}, true, {
                onSelected = function() 
                    ESX.TriggerServerCallback('crixz_inventory:Info', function(allo)
                        data = allo
                    end)
            end}, portMenu)
    ...
    ------------MENu
            ...
            RageUI.Button('Recruter une personne', nil, {RightLabel = "→"}, true, {
                onSelected = function()
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
					  ...
					  TriggerServerEvent('crixz_inventory:recruterplayer', GetPlayerServerId(closestPlayer), job,grade)
				    end
            end});
            ...
            RageUI.Button('Virer une personne', nil, {RightLabel = "→"}, true, {
                onSelected = function()
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
                     ...
                     TriggerServerEvent('crixz_inventory:virerplayer', GetPlayerServerId(closestPlayer))
				  end
            end});
            ...
            RageUI.Button('Promouvoir une personne', nil, {RightLabel = "→"}, true, {
                onSelected = function()
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
                     ...
                     TriggerServerEvent('crixz_inventory:promouvoirplayer', GetPlayerServerId(closestPlayer))
                     print('dep')
				  end
            end});
            ...
            RageUI.Button('Destituer une personne', nil, {RightLabel = "→"}, true, {
                onSelected = function()
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
                     ...
                     TriggerServerEvent('crixz_inventory:destituerplayer', GetPlayerServerId(closestPlayer))
				  end
            end});
        ...
        RageUI.IsVisible(portMenu, function()
            ...
            RageUI.Button('Factures', nil, {}, true, {
                onSelected = function() 
                    ESX.TriggerServerCallback('crixz_inventory:billing', function(bills) ContinentalUtils.Facture = bills end)
                    ESX.TriggerServerCallback('crixz_inventory:Info', function(allo)
                        data = allo
                    end)
                end}, Facture); 
        ...
        RageUI.IsVisible(Weaponmenu, function()
            ...
            RageUI.IsVisible(WeaponMenuuse, function()
                            ...
                            if IsPedOnFoot(closestPed) then
                                ...
                                if ammo > 0 then
                                    if quantity <= ammo and quantity >= 0 then
                                        ...
                                        TriggerServerEvent('crixzInve:ll', GetPlayerServerId(closestPlayer), ContinentalUtils.ItemsUse.name, quantity)
                ...
                RageUI.IsVisible(Divers, function()
                    ...
                    RageUI.Button('Options', nil, {RightLabel = "→"}, true, {onSelected = function() end}, crixzMenu);
                ...
                RageUI.IsVisible(crixzMenu, function()
